...
'active' : '' }} ">
      ...
      <li class="nav-header">manage_user</li>
      <li class="nav-item">
...
'active' : '' }}">
      ...
      <li class="nav-header">manage_level</li>
      <li class="nav-item">
...
'active' : '' }} ">
      ...
      <li class="nav-header">manage_category</li>
      <li class="nav-item">
...
'category')?'active' : '' }} ">
      ...
      <li class="nav-header">manage_goods</li>
      <li class="nav-item">
...
'active' : '' }} ">
      ...
      <li class="nav-header">manage_transaction</li>
      <li class="nav-item">
